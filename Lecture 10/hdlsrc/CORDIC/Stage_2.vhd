-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_2.vhd
...
-- 
-- Module: Stage_2
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_2
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_2 IS

  -- Component Declarations
  COMPONENT Shift_Sel1_block3
  ...
  FOR ALL : Shift_Sel1_block3
    USE ENTITY work.Shift_Sel1_block3(rtl);

  FOR ALL : Shift_Sel_block3
    USE ENTITY work.Shift_Sel_block3(rtl);

  FOR ALL : Phase_Sel_block3
    USE ENTITY work.Phase_Sel_block3(rtl);
...
BEGIN
  -- <S6>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block3
