-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_1.vhd
...
-- 
-- Module: Stage_1
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_1 IS
  ...
  FOR ALL : Shift_Sel1_block
    USE ENTITY work.Shift_Sel1_block(rtl);

  FOR ALL : Shift_Sel_block
    USE ENTITY work.Shift_Sel_block(rtl);

  FOR ALL : Phase_Sel_block
    USE ENTITY work.Phase_Sel_block(rtl);
