-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_6.vhd
...
-- 
-- Module: Stage_6
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_6
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_6 IS

  -- Component Declarations
  COMPONENT Shift_Sel1_block7
  ...
  FOR ALL : Shift_Sel1_block7
    USE ENTITY work.Shift_Sel1_block7(rtl);

  FOR ALL : Shift_Sel_block7
    USE ENTITY work.Shift_Sel_block7(rtl);

  FOR ALL : Phase_Sel_block7
    USE ENTITY work.Phase_Sel_block7(rtl);
...
BEGIN
  -- <S10>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block7
