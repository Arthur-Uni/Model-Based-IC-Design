-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_7.vhd
...
-- 
-- Module: Stage_7
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_7
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_7 IS

  -- Component Declarations
  COMPONENT Shift_Sel1_block8
  ...
  FOR ALL : Shift_Sel1_block8
    USE ENTITY work.Shift_Sel1_block8(rtl);

  FOR ALL : Shift_Sel_block8
    USE ENTITY work.Shift_Sel_block8(rtl);

  FOR ALL : Phase_Sel_block8
    USE ENTITY work.Phase_Sel_block8(rtl);
...
BEGIN
  -- <S11>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block8
