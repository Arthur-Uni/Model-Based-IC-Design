-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Shift_Sel1_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Shift_Sel1_block6
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_5/Shift_Sel1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  -- <S65>/Bit Shift
  Bit_Shift_out1 <= SHIFT_RIGHT(in_signed, 5);
