-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Shift_Sel1_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Shift_Sel1_block4
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_3/Shift_Sel1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  -- <S51>/Bit Shift
  Bit_Shift_out1 <= SHIFT_RIGHT(in_signed, 3);
