-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Phase_Sel_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Phase_Sel_block
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_1/Phase_Sel
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Phase_Sel_block IS
...
BEGIN
  -- <S21>/Constant
  Constant_out1 <= to_signed(16#3B59#, 16);
