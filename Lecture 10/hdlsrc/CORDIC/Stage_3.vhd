-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_3.vhd
...
-- 
-- Module: Stage_3
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_3
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_3 IS
  ...
  FOR ALL : Shift_Sel1_block4
    USE ENTITY work.Shift_Sel1_block4(rtl);

  FOR ALL : Shift_Sel_block4
    USE ENTITY work.Shift_Sel_block4(rtl);

  FOR ALL : Phase_Sel_block4
    USE ENTITY work.Phase_Sel_block4(rtl);
...
BEGIN
  -- <S7>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block4
