-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_4.vhd
...
-- 
-- Module: Stage_4
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_4 IS

  -- Component Declarations
  COMPONENT Shift_Sel1_block5
  ...
  FOR ALL : Shift_Sel1_block5
    USE ENTITY work.Shift_Sel1_block5(rtl);

  FOR ALL : Shift_Sel_block5
    USE ENTITY work.Shift_Sel_block5(rtl);

  FOR ALL : Phase_Sel_block5
    USE ENTITY work.Phase_Sel_block5(rtl);
...
BEGIN
  -- <S8>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block5
