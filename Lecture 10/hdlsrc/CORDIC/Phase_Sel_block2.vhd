-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Phase_Sel_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Phase_Sel_block2
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_11/Phase_Sel
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Phase_Sel_block2 IS
  PORT( sel                               :   IN    std_logic;
        out_rsvd                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En15
        );
END Phase_Sel_block2;


ARCHITECTURE rtl OF Phase_Sel_block2 IS
...
BEGIN
  -- <S35>/Constant
  Constant_out1 <= to_signed(16#0010#, 16);
