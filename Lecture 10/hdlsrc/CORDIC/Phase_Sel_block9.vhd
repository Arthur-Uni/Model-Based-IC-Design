-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Phase_Sel_block9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Phase_Sel_block9
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_8/Phase_Sel
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Phase_Sel_block9 IS
  PORT( sel                               :   IN    std_logic;
        out_rsvd                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En15
        );
END Phase_Sel_block9;


ARCHITECTURE rtl OF Phase_Sel_block9 IS
...
BEGIN
  -- <S84>/Constant
  Constant_out1 <= to_signed(16#0080#, 16);
