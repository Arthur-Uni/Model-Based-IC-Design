-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_11.vhd
...
-- 
-- Module: Stage_11
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_11
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_11 IS

  -- Component Declarations
  COMPONENT Shift_Sel1_block2
  ...
  FOR ALL : Shift_Sel1_block2
    USE ENTITY work.Shift_Sel1_block2(rtl);

  FOR ALL : Shift_Sel_block2
    USE ENTITY work.Shift_Sel_block2(rtl);

  FOR ALL : Phase_Sel_block2
    USE ENTITY work.Phase_Sel_block2(rtl);
...
BEGIN
  -- <S5>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block2
