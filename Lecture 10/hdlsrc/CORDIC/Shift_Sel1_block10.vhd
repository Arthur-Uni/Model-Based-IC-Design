-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Shift_Sel1_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Shift_Sel1_block10
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_9/Shift_Sel1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  -- <S93>/Bit Shift
  Bit_Shift_out1 <= SHIFT_RIGHT(in_signed, 9);
