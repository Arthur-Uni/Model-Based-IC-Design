-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Stage_10.vhd
...
-- 
-- Module: Stage_10
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_10
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Stage_10 IS

  -- Component Declarations
  COMPONENT Shift_Sel1_block1
  ...
  FOR ALL : Shift_Sel1_block1
    USE ENTITY work.Shift_Sel1_block1(rtl);

  FOR ALL : Shift_Sel_block1
    USE ENTITY work.Shift_Sel_block1(rtl);

  FOR ALL : Phase_Sel_block1
    USE ENTITY work.Phase_Sel_block1(rtl);
...
BEGIN
  -- <S4>/Shift_Sel1
  u_Shift_Sel1 : Shift_Sel1_block1
