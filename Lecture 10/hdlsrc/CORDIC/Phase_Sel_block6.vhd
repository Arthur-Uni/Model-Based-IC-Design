-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Phase_Sel_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Phase_Sel_block6
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_5/Phase_Sel
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Phase_Sel_block6 IS
  PORT( sel                               :   IN    std_logic;
        out_rsvd                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En15
        );
END Phase_Sel_block6;


ARCHITECTURE rtl OF Phase_Sel_block6 IS
