-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CORDIC\Shift_Sel_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Shift_Sel_block1
-- Source Path: CORDIC/CORDIC_cos_sin/Stage_10/Shift_Sel
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  -- <S29>/Bit Shift
  Bit_Shift_out1 <= SHIFT_RIGHT(in_signed, 10);
