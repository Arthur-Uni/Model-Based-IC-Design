  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(782108104U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1503609287U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4057430286U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3871306935U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(416691327U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1731713150U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(609694920U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3306408284U);
  }
  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "RYqNyMLNM0WPr4qIfFBFDE") == 0) {
  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sRYEXZyrvp4yyVCS37lJdgH") == 0) {
...
unsigned int sf_test_jit_fallback_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sRYEXZyrvp4yyVCS37lJdgH") == 0) {
          extern mxArray *sf_c3_test_jit_fallback_info(void);
          plhs[0] = sf_c3_test_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sRYEXZyrvp4yyVCS37lJdgH") == 0) {
          extern mxArray *sf_c3_test_updateBuildInfo_args_info(void);
          plhs[0] = sf_c3_test_updateBuildInfo_args_info();
          break;
        }
      }
...
mxArray* load_test_optimization_info(boolean_T isRtwGen, boolean_T isModelRef,
  boolean_T isExternal)
{
