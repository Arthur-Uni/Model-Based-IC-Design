...
MODEL     = TapFilter
TARGET      = sfun
MODULE_SRCS   = c2_TapFilter.c
MODEL_SRC  = TapFilter_sfun.c
MODEL_REG = TapFilter_sfun_registry.c
MAKEFILE    = TapFilter_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Arthur\Desktop\Model Based IC Design\Lecture 6\HW 6\slprj\_sfprj\TapFilter\_self\sfun\src" 
...
OBJLIST_FILE = TapFilter_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
