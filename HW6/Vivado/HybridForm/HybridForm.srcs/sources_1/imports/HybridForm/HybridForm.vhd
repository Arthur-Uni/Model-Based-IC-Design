-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\HybridForm\HybridForm.vhd
-- Created: 2018-10-26 21:01:01
-- 
...
-- 
-- Module: HybridForm
-- Source Path: HybridForm/HybridForm
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF HybridForm IS
  ...
  SIGNAL Delay1_out1                      : signed(7 DOWNTO 0);  -- sfix8_En6
...
BEGIN
  ...
  -- <S1>/Product2
  Product2_mul_temp <= Constant2_out1 * Delay_out1;
  ...
  Add1_add_cast_1 <= resize(Delay1_out1 & '0', 32);
