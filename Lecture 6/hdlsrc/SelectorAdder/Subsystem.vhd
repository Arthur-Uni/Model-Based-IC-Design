-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\SelectorAdder\Subsystem.vhd
-- Created: 2018-10-16 04:24:37
-- 
...
-- 
-- Module: Subsystem
-- Source Path: SelectorAdder/Subsystem
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Subsystem IS
  ...
  SIGNAL Add_add_cast                     : unsigned(2 DOWNTO 0);  -- ufix2_En1
  SIGNAL Add_add_cast_1                   : unsigned(2 DOWNTO 0);  -- ufix2_En1
  SIGNAL Add_add_temp                     : unsigned(2 DOWNTO 0);  -- ufix2_En1
...
BEGIN
  ...
  -- <S1>/Add
  Add_add_cast <= resize(In1_unsigned & '0', 3);
  Add_add_cast_1 <= resize(Constant4_out1, 3);
  Add_add_temp <= Add_add_cast + Add_add_cast_1;
  Add_out1 <= Add_add_temp;
